    ...
    return (
        <div className="profile-container">
            ...
            <div className="developers">
                ...
                <p>Джон Доу - Design</p>
                <a className="github-button" href="https://github.com/slidrex/bonchwash" target="_blank" data-icon="octicon-star"
                   data-size="large" aria-label="Star slidrex/bonchwash on GitHub">GitHub</a>
            </div>
        </div>
    );
}
